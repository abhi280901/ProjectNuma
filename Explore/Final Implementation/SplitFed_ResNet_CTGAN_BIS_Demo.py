...
net_client.load_state_dict(torch.load("best_client_model_CTGAN_ResNet_V2_wo_drop_128_005.pth"))
net_server.load_state_dict(torch.load("best_server_model_CTGAN_ResNet_V2_wo_drop_128_005.pth"))

...
program = "SplitFed_ResNet_CTGAN_ep10_lep_2_lr5e-3_top2_128"
print(program)
print(f"---------{program}----------")
...
for iter in range(epochs):
    ...
    if len(loss_test_collect) > 0:
        ...
        if current_loss < best_test_loss:
            ...
            torch.save(net_glob_client.state_dict(), "best_client_model_CTGAN_ResNet_V2_wo_drop_128_005.pth")
            torch.save(net_glob_server.state_dict(), "best_server_model_CTGAN_ResNet_V2_wo_drop_128_005.pth")
